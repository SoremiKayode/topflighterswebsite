  ...
  >
    <AnimatePresence mode="popLayout" initial={false}>
      <motion.div
        ...
        initial={{clipPath:'circle(0% at 88% 82%)',x:36}}
        animate={{clipPath:'circle(155% at 88% 82%)',x:0}}
        exit={{opacity:0,scale:.985}}
        transition={{clipPath:{duration:1.05,ease:[.22,1,.36,1]},x:{duration:.7},opacity:{duration:.45}}}
        role="group"
...
function EnrollmentSlide(){return <div className="h-full bg-[linear-gradient(120deg,#f7fbff_0%,#e9f4ff_48%,#dcecff_100%)] pb-24 pt-10 lg:pt-14"><div className="container-wide grid h-full items-center gap-8 lg:grid-cols-[.9fr_1.1fr]">
  <div className="relative z-10">
    <span className="eyebrow"><Plane size={16}/> Admissions now open</span>
    <h1 className="max-w-2xl text-[clamp(3rem,6vw,5.5rem)] font-extrabold uppercase leading-[.88] text-navy">Enrollment<br/><span className="text-green">in progress!</span></h1>
